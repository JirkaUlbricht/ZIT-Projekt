...
const triviaFacts = [
  ...
  "Debugging je jako být detektivem v zločinu, kde jste také hlavním podezřelým.",
  ...
  "Segmentation fault (fact dumped)",
  ...
  "Chcete programovat bez bugů? Podívejte se na toto skvělé video: https://www.youtube.com/watch?v=dQw4w9WgXcQ",
  "Proč je správce databáze tak vtipný? Protože má SQLý smysl pro humor.",
  "Kolik programátorů je potřeba k výměně žárovky? Žádný, to je hardwarový problém.",
  "Když něco nejde, pořád existuje --force, pokud ani ten nejde tak je něco špatně.",
  "Na Githubu je dnes přibližně přes 420 miliónů repozitářů.",
  "Nedávný výpadek Cloudflaru způsobil problémy až u 19.3% všech webů na celém internetu.",
  "První 1GB pevný disk byl představen společností IBM v roce 1980 a vážil přibližně 250 kg.",
  "Doména pro sovětský svaz .su stále existuje a je provozována, narozdíl od domén pro jiné zaniklé státy jako .yu (Jugoslávie) nebo .cs (Československo).",
  "Rozdíl mezi UDP a TCP je v tom, že UDP je jako posílat dopisy bez obálky a doufat, že nějaký dojde, zatímco TCP je jako posílat dopis s potvrzením o doručení.",
  "Většina dnešních nejznámějších webových prohlížečů je postavena na jádru Chromium, které je open-source projekt vyvinutý Googlem.",
  "Wannacry byl ransomware, který v květnu 2017 infikoval stovky tisíc počítačů ve více než 150 zemích a využíval zranitelnost v systému Windows známou jako EternalBlue.",
  "Ransomware je typ škodlivého softwaru, který šifruje soubory oběti a požaduje výkupné za jejich dešifrování, po jeho zaplacení ale často nedojde k obnovení přístupu k datům.",
  "Seznam byl založen v roce 1996 Ivem Lukačovičem a je jedním z největších internetových portálů v České republice.",
  "Windows 1.0 měl méně než 1 MB velikosti, oproti tomu Windows 11 vyžaduje minimálně 64 GB volného místa na disku.",
